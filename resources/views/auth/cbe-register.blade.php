                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                required
                                class="w-full px-4 py-2.5 pr-11 rounded-xl border border-slate-200 text-slate-800 text-xs focus:ring-2 focus:ring-blue-600 focus:outline-none transition"
                            >
                            <button
                                type="button"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button
                                type="button"
                                onclick="toggleRegPassword('password_confirmation', this)"
                                class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-blue-600 transition focus:outline-none"
                                title="Show / Hide Password"
                            >
                                <i class="fa-regular fa-eye text-sm"></i>
