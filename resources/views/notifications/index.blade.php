<x-layouts.cbe title="Taarifa (Notifications) - CBE Portal">
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm">
            <div>
                <h1 class="text-2xl font-black text-slate-900">Taarifa na Matangazo (Notifications)</h1>
                <p class="text-xs text-slate-500 mt-1">Ujumbe na taarifa zote zilizotumwa kwako.</p>
            </div>
