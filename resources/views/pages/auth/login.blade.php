            ...
            <div class="grid lg:grid-cols-[1.15fr_0.85fr]">
                        ...
                        <div>
                            <div class="mb-6 flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-sky-100">Support Portal</p>
                                </div>
                            </div>

                            <h1 class="max-w-md text-4xl font-bold leading-tight lg:text-5xl">Secure Service Desk Access</h1>
                            <p class="mt-4 max-w-lg text-base text-slate-200">
                                Submit requests, track issues, and manage support tickets across office, IT, field, and technical operations.
                            </p>
                        </div>

                        <div class="relative rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                            <div class="mb-3 text-[0.7rem] font-semibold uppercase tracking-[0.3em] text-emerald-200">Operational snapshot</div>
                            <div class="grid grid-cols-3 gap-3 text-center">
                                <div class="rounded-xl bg-white/5 p-3">
                                    <div class="text-2xl font-bold text-white">24/7</div>
                                    <div class="text-[0.65rem] text-slate-200 uppercase tracking-wider">Support</div>
                                </div>
                                <div class="rounded-xl bg-white/5 p-3">
                                    <div class="text-2xl font-bold text-white">180+</div>
                                    <div class="text-[0.65rem] text-slate-200 uppercase tracking-wider">Tickets</div>
                                </div>
                                <div class="rounded-xl bg-white/5 p-3">
                                    <div class="text-2xl font-bold text-white">99%</div>
                                    <div class="text-[0.65rem] text-slate-200 uppercase tracking-wider">Uptime</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white p-6 sm:p-8 lg:p-10">
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="mb-2 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800">
                            Login as Admin or Staff Member to access the GST helpdesk portal.
                        </div>

                        <form method="POST" action="{{ route('login.store') }}" class="mx-auto flex w-full max-w-xl flex-col gap-5">
                            @csrf
                        ...
                        <div class="mt-2 text-center text-sm text-zinc-600">
                            <flux:link :href="route('admin.login')" wire:navigate>{{ __('Admin login') }}</flux:link>
                        </div>
